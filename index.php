...
<head>
  ...
  <link rel="alternate stylesheet" type="text/css" href="assets/switcher/css/red.css" title="orange" media="all" data-default-color="true" />
  ...
  <section class="section-padding gray-bg">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p>Car rental is a service provided by companies that allows customers to rent vehicles for a specified period of time, typically ranging from a few hours to several weeks or even months. </p>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6 col-sm-3">
          <div class="fun-facts-m">
            <div class="cell">
              <?php
              $sql = "SELECT COUNT(id) from  tblbrands ";
              $query = $dbh->prepare($sql);
              $query->execute();
              ...
              <h2><i class="fa fa-calendar" aria-hidden="true"><?php echo $row["id"]; ?></i></h2>
              <p>Brands we Have</p>
            </div>
          </div>
        </div>
