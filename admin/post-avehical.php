		...
		<div class="ts-main-content">
			...
			<div class="content-wrapper">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-title" style="text-align: center; "><b>POST A VEHICLE</b></h2>
							<div class="row">
								<div class="col-md-12">
										...
										<div class="panel-body" style="margin-top: 15px; ">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="number" name="priceperday" pattern="[0-9]{5}" maxlength="5" title="Only number allowed" class="form-control" required>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="modelyear" maxlength="4" pattern="^(19|20)\d{2}$" title="Only Year allowed in 4 digit" class="form-control" required>
													</div>
													<!-- <label class="col-sm-2 control-label">Seating Capacity<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="text" name="seatingcapacity" class="form-control" required> -->
													<label class="col-sm-2 control-label">Select seating Capacity<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<select class="selectpicker" name="seatingcapacity" class="form-control" required>
									...
									<div class="panel-body">
										<div class="form-group">
											<div class="form-group">
												...
												<div class="col-sm-4">
													Image 3
													<span style="color:red">*</span><input type="file" name="img3" required>
												</div>
											</div>
