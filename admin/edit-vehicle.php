												...
												foreach ($results as $result) {	?>
													...
													<form method="post" class="form-horizontal" enctype="multipart/form-data">
														...
														<div class="form-group">
															...
															<div class="col-sm-4" style="text-align:center">
																Image 3
																<br><img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3); ?>" width="300" height="200" style="border:solid 1px #000">
																<br>
																<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id) ?>">
																	Change Image 3
																</a>
															</div>
														</div>
														...
														<div class="form-group">
															<div class="col-sm-4" style="text-align:center">
																Image 4
																<br><img src="img/vehicleimages/<?php echo htmlentities($result->Vimage4); ?>" width="300" height="200" style="border:solid 1px #000">
																<br>
														...
														<?php } else { ?>
															...
															<div class="form-group">
																<div class="col-sm-8 col-sm-offset-2">
																	...
																	<button class="btn btn-primary" href="./manage-vehicles.php" name="submit" type="submit" style="margin-top:4%">Save changes</button>
																</div>
															</div>
