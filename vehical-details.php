              ...
              <div class="sidebar_widget">
                ...
                <form method="post">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="fromdate" min="<?php echo date('Y-m-d'); ?>" placeholder="From Date" required>
                  </div>
                  <div class="form-group">
                    <label>To Date:</label>
                    <input type="date" class="form-control" name="todate" min="<?php echo date('Y-m-d'); ?>" placeholder="To Date" required>
                  </div>
                  <div class="form-group">
